        ...
        <div className='container px-5'>
            <div className='row text-center mb-5 p-5'>
                ...
                <div className='col-7 m-5'>
                    <h2 className='fs-4' style={{color:"#424242",lineHeight:"1.5"}}>We pioneered the discount broking model in India.<br></br>
Now, we are breaking ground with our technology.</h2>
            ...
            <div className='row p-5 mt-5 fs-6' style={{color:"#424242", lineHeight:"1.9"}}>
